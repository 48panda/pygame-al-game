...
build_exe_options = {"includes": ["pygame"],
                    ...
                    "fonttools", "html", "http", "idna", "inportlib", "importlib_metadata", "ipykernel", "Ipython", "ipython_genutils", "jedi", "jinja2", "json", "jsonschema", "jupyter_client", "jupyter_core",
                    "lib2to3","lib", "logging", "lxml", "markupsafe", "matplotlib", "more_itertools", "mpl_toolkits", "mpmath", "multiprocessing", "nbconvert", "nbformat", "notebook", "OpenGL", "OpenGL_accelerate",
                    "packaging", "pandas", "parso", "pathlib2", "pathspec", "PIL", "pkg_resources", "platrformdirs", "pluggy", "prompt_toolkit", "py", "pycparser", "pydoc_data", "pyglet", "pygments", "PyQt5",
