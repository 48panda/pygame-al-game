...
def do_character_creation(screen, clock):
  ...
  fixed.blit(pygame.font.Font("assets/fonts/Montserrat-ExtraBoldItalic.ttf", 96).render("Create your character", True, (255,255,255)), (0,0))
  ...
  while not done:
    ...
    charCreationVals.skincolor.rgb(skin_color())
    charCreationVals.haircolor.rgb(hair_color())
    charCreationVals.eyecolor.rgb(eye_color())
    charCreationVals.topcolor.rgb(top_color())
    charCreationVals.legcolor.rgb(legs_color())
